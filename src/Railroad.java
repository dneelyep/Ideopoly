...
public class Railroad extends BoardCell {
    ...
    public Railroad(String new_name, Icon new_image, int pos_x, int pos_y, String edge) {
	super(new_name, new_image, pos_x, pos_y, edge); // Use the BoardCell class' constructor.
    }
}