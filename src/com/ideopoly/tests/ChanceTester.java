...
public class ChanceTester extends TestCase {
    ...
    public void testChance3() {
        ...
        // expectedCash = Integer.parseInt(player1.getCash(CASH_TYPES.total) - (roll * 10);
        // assertEquals(Integer.parseInt(player1.getCash(CASH_TYPES.total) < 1500, true);

        // roll = rollGenerator.nextInt(6) + 1;
        // expectedCash = Integer.parseInt(player2.getCash(CASH_TYPES.total) - (roll * 10);
        // assertEquals(player2.getCash(CASH_TYPES.total"), expectedCash);

        // roll = rollGenerator.nextInt(6) + 1;
        // expectedCash = Integer.parseInt(player3.getCash(CASH_TYPES.total) - (roll * 10);
        // assertEquals(player3.getCash(CASH_TYPES.total"), expectedCash);

        // roll = rollGenerator.nextInt(6) + 1;
        // expectedCash = Integer.parseInt(player4.getCash(CASH_TYPES.total) - (roll * 10);
        // assertEquals(player4.getCash(CASH_TYPES.total"), expectedCash);
        ...
        // assertEquals(player1.getCash(CASH_TYPES.total"), 103);
        // assertEquals(player2.getCash(CASH_TYPES.total"), 102);
        // assertEquals(player3.getCash(CASH_TYPES.total"), 101);
        // assertEquals(player4.getCash(CASH_TYPES.total"), 100);
        ...
        // TestHelper.doActionsAllPlayers(player1, player2, player3, player4, chanceCard, board);
        // assertEquals(player1.getCash(CASH_TYPES.total"), 143);
        // assertEquals(player2.getCash(CASH_TYPES.total"), 142);
        // assertEquals(player3.getCash(CASH_TYPES.total"), 141);
        // assertEquals(player4.getCash(CASH_TYPES.total"), 140);
    ...
    public void testChance8() {
        ...
        // assertEquals(player1.getCash(CASH_TYPES.total"), 1300);
        // assertEquals(player2.getCash(CASH_TYPES.total"), 1300);
        // assertEquals(player3.getCash(CASH_TYPES.total"), 1300);
        // assertEquals(player4.getCash(CASH_TYPES.total"), 1300);
