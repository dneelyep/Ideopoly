...
public class PropagandaOutletTester extends TestCase {
    ...
    public void testPropagandaOutlet() {
        GameBoard board = new GameBoard("Test Board");

        // TODO: Removed this image
        PropagandaOutlet testPropOutlet = new PropagandaOutlet("testPropOutlet", "images/yellow_template.jpg", 40, 10, 60, 180, 350, 630, 800, 100, new Point(18, 18), board, new Color(252, 255, 0));
        ...
        assertEquals(testPropOutlet.getCoordinates().x, 18);
        assertEquals(testPropOutlet.getCoordinates().y, 18);
        ...
        Player testPropOutletPlayer = new Player(2, new Color(223, 254, 10), board);
